...
import { LeadsPushService } from './services/leads-push.service';

@Module({
  imports: [UserModule, KafkaModule],
  controllers: [VisitorController, VisitorConsumer],
  providers: [VisitorService, VisitorValidationService, BadgeService, QuestionnaireService, EmailService, LeadsPushService],
})
